    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('book', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='user.Book', verbose_name='书籍')),
            ],
            options={
                'verbose_name': '评分',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('content', models.CharField(max_length=32, verbose_name='内容')),
                ('addtime', models.DateTimeField(auto_now_add=True)),
                ('liuyan', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='user.Liuyan', verbose_name='留言')),
        ...
        migrations.AddField(
            model_name='action',
            name='new',
            field=models.ManyToManyField(blank=True, related_name='newuser', to='user.User', verbose_name='审核用户'),
        ),
        migrations.AddField(
            model_name='action',
            name='user',

...
class Edit(forms.ModelForm):
    class Meta:
        ...
        laebls={'password':'密码','name':'昵称','email':'邮箱','address':'地址','phone':'手机号码'}
        widgets={'password':forms.PasswordInput(attrs={'class':'form-control'}),'name':forms.TextInput(attrs={'class':'form-control'}),'email':forms.EmailInput(attrs={'class':'form-control'}),'address':forms.TextInput(attrs={'class':'form-control'}),'phone':forms.NumberInput(attrs={'class':'form-control'})}
        def clean_name(self):
...
class RegisterForm(forms.Form):
    ...
    phone=forms.CharField(label="电话",max_length=128,widget=forms.NumberInput(attrs={'class':'form-control'}))
